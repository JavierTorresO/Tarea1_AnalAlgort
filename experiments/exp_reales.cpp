...
int main(int argc, char *argv[])
{
    ...
    for (n = lower; n <= upper; n *= step) {
        ...
        // =========================================================
        // Generamos matrices con reales entre 0 y 1 de tamaño n x n
        Matrix A = randomDoubleMatrix(n, 0.0, 1.0);
        Matrix B = randomDoubleMatrix(n, 0.0, 1.0);
        ...
        for (i = 0; i < runs; i++) {
            ...
            // FUNCIÓN A MEDIR
            // =========================================================
            // AQUÍ DECIDES QUÉ ALGORITMO CORRER (Por ahora usaremos Strassen)
            //Matrix C = strassenMultiply(A, B);
            
            // Si luego quieres medir el clásico, comentas arriba y descomentas abajo:
